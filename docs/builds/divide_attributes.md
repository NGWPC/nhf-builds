...
2. `example_divide_attributes_config.yaml` is set to run on a small test case. Change `divides_path` to your desired domain.
...
Then, in `example_divide_attributes_config.yaml`, do one of the following:
